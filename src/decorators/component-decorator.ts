...
import { ENCAPSULATION } from '../../stencil/src/util/constants';
// import { getDeclarationParameters, isDecoratorNamed, serializeSymbol } from './utils';
import { getStylesMeta } from '../../stencil/src/compiler/transpile/datacollection/styles-meta';
// import ts from 'typescript';


export function getComponentDecoratorMeta(componentOptions: d.ComponentOptions/*diagnostics: d.Diagnostic[], checker: ts.TypeChecker, node: ts.ClassDeclaration*/): d.ComponentMeta | undefined {
//   if (!node.decorators) {
//     return undefined;
//   }
...
function getHostMeta(hostData: d.HostMeta) {
  hostData = hostData || {};
